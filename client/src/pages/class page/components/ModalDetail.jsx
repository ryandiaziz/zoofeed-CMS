...
const ModalDetail = (props) => {
  ...
  const setData = async () => {
    await detailClass(+props.id, (result) => {
      setClassData(result)
                ...
                <div className="relative p-6 flex">
                  ...
                  <div className='bg-gray-50 dark:bg-slate-800 h-auto w-[20%] mx-2 shadow-lg rounded-md p-3'>
                    <img
                      ...
                      src={`http://localhost:3000/${classData.imageUrl}`}
                    />
                  ...
                  <div className='bg-white dark:bg-slate-800 h-auto w-[80%] p-3 shadow-lg rounded-md'>
                    <div className='mb-3'>
                      ...
                      <p className='dark:text-slate-200 font-light text-slate-700 text-[16px]'>{classData.description}</p>
                    </div>
                  </div>
                </div>
                {/* consume */}
