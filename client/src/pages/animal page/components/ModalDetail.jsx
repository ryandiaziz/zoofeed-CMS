                                ...
                                <div className='relative w-1/3'>
                                    <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white dark:bg-gray-700 outline-none focus:outline-none">
                                        ...
                                        <div className='mx-5 mb-5'>
                                            <button onClick={() => submithandle()} type="submit" class=" w-full text-white bg-[#019267] hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="relative p-6 flex">
                                    ...
                                    <div className='bg-gray-50 dark:bg-slate-800 h-auto w-[20%] mx-2 shadow-lg rounded-md p-3'>
                                        <img
                                            ...
                                            src={`http://localhost:3000/${detail.data.imageUrl}`}
                                        />
